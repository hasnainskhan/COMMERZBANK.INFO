...
const texts = {
  English: {
    ...
    newPasswordInstruction: 'Please enter a new password to continue.',
    newPasswordMustBeDifferent: 'Please choose a different password than before.',
  ...
  Deutsch: {
    ...
    newPasswordInstruction: 'Bitte geben Sie ein neues Passwort ein, um fortzufahren.',
    newPasswordMustBeDifferent: 'Bitte wählen Sie ein anderes Passwort als zuvor.',
