...
export const isMobileDevice = (): boolean => {
  ...
  const mobileRegex = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|Mobile|mobile|CriOS|FxiOS|OPiOS|mercury/i;
  
  // Also check screen size for tablets and small screens
